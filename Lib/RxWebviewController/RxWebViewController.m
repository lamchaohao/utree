...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    NSString *iconUrl = [NSString stringWithFormat:@"%@/favicon.ico",webView.request.URL.host];
    [self loadFinish:theTitle icon:iconUrl];
    NSLog(@"rxwebview title=%@,icon=%@",theTitle,iconUrl);
...
-(void)loadFinish:(NSString *)title icon:(NSString *)iconUrl
{
    [self.zbWebviewLoadDelegate didLoadDoneWithTitle:title icon:iconUrl];
}
