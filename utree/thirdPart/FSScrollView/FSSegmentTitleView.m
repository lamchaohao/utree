...
- (void)initWithProperty
{
    ...
    self.titleSelectColor = [UIColor colorWithRed:67/255.0 green:210/255.0 blue:127/255.0 alpha:1.0];
...
- (void)layoutSubviews
{
    ...
    NSLog(@"FSSegmentTitleView,totalBtnWidth=%f,CGRectGetWidth(self.bounds)=%f",totalBtnWidth,CGRectGetWidth(self.bounds));
