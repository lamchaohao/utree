...
//外部 - 可用安全高度
#define Screen_Security_Hight (iS_IPhoneX_All ? [UIScreen mainScreen].bounds.size.height - iPhone_SNavH  - iPhone_Safe_BottomNavH : [UIScreen mainScreen].bounds.size.height)
...
#define iPhone_Safe_BottomNavH (iS_IPhoneX_All ? 34  : 0)
...
#define iPhone_Bottom_NavH (iS_IPhoneX_All ? iPhone_Safe_BottomNavH + 49 : 49)
