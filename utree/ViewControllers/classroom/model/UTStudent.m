...
- (instancetype)initWithStuName:(NSString *)stuName andScore:(NSInteger)score
{
    ...
    self.dropRecord = score;
    self.fileDo = [[FileObject alloc]init];
    self.fileDo.path = @"https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2997599414,2721860663&fm=26&gp=0.jpg";
