...
{
    switch (model.excitationType.intValue) {
        case 1:
            _tabLabel.text = @"学";
            break;
        case 2:
    ...
    _itemScoreLabel.text = [NSString stringWithFormat:@"%d",model.dropPoint.intValue];
    
    _itemName.text = model.excitationName;
    
    [_headView sd_setImageWithURL:[NSURL URLWithString:model.icon.path]];
