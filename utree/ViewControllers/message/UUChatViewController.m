...
- (void)viewDidLoad {
    ...
    _chatTableView.frame = CGRectMake(0, 0, self.view.uu_width, self.view.uu_height-40-iPhone_Safe_BottomNavH);
...
- (void)initBasicViews
{
    _chatTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.uu_width, self.view.uu_height-40-iPhone_Safe_BottomNavH) style:UITableViewStylePlain];
